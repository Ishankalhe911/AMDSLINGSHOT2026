...
export class Backend implements backendInterface {
    ...
    async addChallenge(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addChallenge(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getChallenge(arg0: string): Promise<Challenge> {
        if (this.processError) {
            try {
    ...
    async storeMentorResponse(arg0: string, arg1: MentorResponse): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeMentorResponse(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
